...
export default function InvoicesCreate() {
    const pageProps = usePage().props as unknown as InvoicesCreateProps;
            ...
            <div className="min-h-screen bg-slate-950">
                ...
                <div className="p-8">
                    <form onSubmit={handleSubmit} className="max-w-4xl">
                        ...
                        <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6 mb-6">
                            <h2 className="text-lg font-semibold text-white mb-4">Fechas y Totales</h2>
                            <div className="grid grid-cols-3 gap-4 mb-6">
                                <div>
                                    <label className="block text-slate-400 text-sm mb-1">Fecha de Emisión *</label>
                                    <input
                                        type="date"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="flex items-end justify-end">
                                    <div className="text-right">
                                        ...
                                        <p className="text-xl font-bold text-cyan-400 mt-2">Total: ${total.toFixed(2)}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6 mb-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-slate-400 text-sm mb-1">Términos de Pago</label>
                                    <textarea
                                        value={data.terms}
                                        onChange={(e) => setData('terms', e.target.value)}
                                        rows={4}
                                        placeholder="Métodos de pago, penalties, etc."
                                        className="w-full px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white"
                                    />
                                </div>
                            </div>
