...
export default function QuotesCreate() {
    ...
    const { clients = [], selected_client_id, preselected_service } = pageProps;
    ...
    useEffect(() => {
        if (preselected_service) {
            setItems([{ description: preselected_service, quantity: 1, unit_price: 0 }]);
            setData('items', [{ description: preselected_service, quantity: 1, unit_price: 0 }]);
        }
    }, [preselected_service]);
